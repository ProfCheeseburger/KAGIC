...
public class EntityBlueDiamond extends EntityGem {
    ...
    public void addTrackingPlayer(EntityPlayerMP player) {
        this.world.playSound(null, player.getPosition(), ModSounds.RECORD_BLUE_DIAMOND, SoundCategory.MUSIC, 100.0F, 1.0F);
        this.world.playSound(null, player.getPosition(), ModSounds.BLUE_DIAMOND_INTRO, SoundCategory.HOSTILE, 10.0F, 1.0F);
        super.addTrackingPlayer(player);
        this.healthBar.addPlayer(player);
    }
    public void removeTrackingPlayer(EntityPlayerMP player) {
    	this.world.playSound(null, player.getPosition(), ModSounds.BLUE_DIAMOND_OUTRO, SoundCategory.HOSTILE, 10.0F, 1.0F);
